...
def parse_multipart(rfile, headers) -> Optional[cgi.FieldStorage]:
...
def read_uploaded_file(form: cgi.FieldStorage, field: str = "file") -> Tuple[Optional[bytes], Optional[str]]:
...
def iter_uploaded_files(form: cgi.FieldStorage, *fields: str) -> list[Tuple[str, bytes]]:
