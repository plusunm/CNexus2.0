"""Conversation inference profiles — precision vs emergent (consensus entropy)."""

from __future__ import annotations

from typing import Any, Dict

from core.entropy import format_entropy_seed, temperature_from_seed
...
def get_inference_params(thinking_mode: str, global_entropy: int) -> Dict[str, Any]:
